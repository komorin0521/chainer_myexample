...
#モデルを定義
#ネットワークおよび損失関数を定義
#model = L.Classifier(net.ImageClassifyModel(32*32,n_units,5), lossfun=F.softmax_cross_entropy)

model = L.Classifier(net.ImageClassifyModelwithDropOut(32*32,n_units,5),lossfun=F.softmax_cross_entropy)
...
with open("../05_model/model_cpu.pk", "wb") as of:
