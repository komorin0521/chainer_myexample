...
def importingargs():
    ...
    parser.add_argument("--imagefilepath", "-if", help="imagefilepath you want to predict")
    args = parser.parse_args()
    return args.first_hidden_layer_units, args.second_hidden_layer_units, args.label_num, args.modelpath, args.labelfilepath, args.imagefilepath

def main():
    """
    main
    """
    n_units_h1, n_units_h2, n_out, modelpath, labelfilepath, imagefilepath = importingargs()
